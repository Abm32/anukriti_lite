...
Anukriti integrates a lightweight Web3 verification layer where each simulation
output is cryptographically hashed and can be anchored on-chain. The sensitive
pharmacogenomics data stays off-chain; Solana stores only a deterministic proof
reference.
